...
def pushArtistToDb(name):
	author = getAllArtistTracks(name)
	for song in author:
		pushLyricsToDb(cleanLyrics(getTrackLyrics(getTrackId(name, song))))
...
# sample_lyrics = "Who am I but me?\nI'm exhausted barely breathing\n(WOW) who it is great philosophy but me"
